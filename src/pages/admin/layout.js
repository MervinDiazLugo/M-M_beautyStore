    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#0f0f1a', width: '100%' }}>
      <nav style={{ backgroundColor: '#161625', borderBottom: '1px solid #2a2a3e', width: '100%' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: isMobile ? '56px' : '64px' }}>
            <Link href="/admin" style={{ fontSize: isMobile ? '1rem' : '1.25rem', fontWeight: '800', color: '#f472b6', textDecoration: 'none', letterSpacing: '-0.025em' }}>
      ...
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: isMobile ? '1rem 0.75rem' : '1.5rem 1rem' }}>
        {children}
      </main>
    </div>
  );
